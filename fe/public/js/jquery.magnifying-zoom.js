...
jQuery( window ).on( "load", function() {
    ...
    if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
        jQuery("#magni_img").addClass('imagepop');

        jQuery("#magni_img").on("click", function(e) {
            e.preventDefault();
            jQuery('#imagepreview').attr('src', $(this).attr('href')); // here asign the image to the modal when the user click the enlarge link
        ...
        jQuery("#magni_img").mlens({
            ...
            lensSize: 240, // size of the lens (in px)
