...
namespace App\AppCustom\Models\Sentinel;
...
use App\AppCustom\Models\ModelCustomBase;

class User extends ModelCustomBase implements RoleableInterface, PermissibleInterface, PersistableInterface, UserInterface
{
    use PermissibleTrait;

	use SoftDeletes;
	
	//Dont log Model activity
	//protected $customProperyNotLog = true;
 ...
 /**
     ...
     * @var string
     */
    protected static $rolesModel = 'App\AppCustom\Models\Sentinel\UserRole';
	...
	static function findWithType($id,$type)
    {
	...
	/**
     * Scope a query to only an user type.
     *
