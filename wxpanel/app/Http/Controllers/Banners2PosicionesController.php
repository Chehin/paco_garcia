...
class Banners2PosicionesController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->resource = 'banners2Posiciones';
        $this->resourceLabel = 'CTA Posición';
        $this->modelName = 'App\AppCustom\Models\Banners2Posiciones';
