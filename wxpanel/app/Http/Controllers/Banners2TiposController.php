...
class Banners2TiposController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->resource = 'banners2Tipos';
        $this->resourceLabel = 'CTO Tipos';
        $this->modelName = 'App\AppCustom\Models\Banners2Tipos';
