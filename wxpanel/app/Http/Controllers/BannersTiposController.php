...
class BannersTiposController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->resource = 'bannersTipos';
        $this->resourceLabel = 'Tipos de Banners';
        $this->modelName = 'App\AppCustom\Models\BannersTipos';
