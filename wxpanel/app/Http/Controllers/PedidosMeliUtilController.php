...
class PedidosMeliUtilController extends GenericUtilController
{
    public function __construct(PedidosMeliController $res) {
		...
		$this->aCustomViewData['aMetPago'] = Util::getEnum('pedidos_pedidos_meli', 'metodo_pago');
