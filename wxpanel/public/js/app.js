...
$(document).ready(function() {
	...
	$('#refresh').click(function(e) {
		$.SmartMessageBox({
			title : "<i class='fa fa-refresh' style='color:green'></i> Borrar la memoria local",
			content : "&iquest;Le gustar&iacute;a Restablecer todos sus widgets guardados y eliminar almacenamiento local?",
			buttons : '[No][Si]'
	...
	$('#logout a').click(function(e) {
		...
		var htmlOptions = $this.data('logout-options');
		
		if ('undefined' !== typeof htmlOptions) {
			options =  $this.data('logout-options').split('|');
			
		}
		
		$.logoutOptions = '['+ options[1] + ']['+ options[0] + ']';
