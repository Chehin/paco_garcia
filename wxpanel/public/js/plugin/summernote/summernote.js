    ...
    var aToolbarItem = {
      ...
      paragraph:
        ...
        '<ul class="dropdown-menu">' +
          ...
          '<button type="button" class="btn btn-default" title="Outdent" data-shortcut="Ctrl+[" data-mac-shortcut="⌘+[" data-event="outdent" tabindex="-1"><i class="fa fa-indent-left"></i></button>' +
          '<button type="button" class="btn btn-default" title="Indent" data-shortcut="Ctrl+]" data-mac-shortcut="⌘+]" data-event="indent" tabindex="-1"><i class="fa fa-indent-right"></i></button>' +
          '</li>' +
        '</ul>',
      height:
      ...
      fullscreen:
        '<button type="button" class="btn btn-default" title="Full Screen" data-event="fullscreen" tabindex="-1"><i class="fa fa-fullscreen"></i></button>',
      codeview:
