        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                ...
                { "mData": "cliente", "aTargets":[3], "sortable":true },
                { "mData": "inicio", "aTargets":[4], "sortable":true, "mRender": function(value, type, full){
                        return moment(value, "YYYY-MM-DD").format("DD/MM/YYYY");
                    }
                },
                { "mData": "fin", "aTargets":[5], "sortable":true, "mRender": function(value, type, full){
                        return moment(value, "YYYY-MM-DD").format("DD/MM/YYYY");
                    }
                },
                { "mData": "impresiones", "aTargets":[6], "sortable":true },
                { "mData": "clicks", "aTargets":[7], "sortable":true },
                { "mData": "", "aTargets":[8], "sortable":false, "mRender": function(value, type, full){
