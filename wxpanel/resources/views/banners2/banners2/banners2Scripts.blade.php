        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                ...
                { "mData": "tipo", "aTargets":[1], "sortable":true },
                { "mData": "posicion", "aTargets":[2], "sortable":true },
                { "mData": null, "aTargets":[3], "sortable":false, "sClass": "center", "mRender": function(value, type, full){
                
                    if(full.lista!=null){
                        return '<a href="javascript:;" ><span data-href="'+ resourceReqOption3.edit.url(full.id_lista) + '" data-toggle="modal-custom">'+full.lista+'</span></a>';
                    }else{
                        return '<a href="javascript:;" ><span data-href="'+ resourceReqOption3.edit.url(full.id_lista) + '" data-toggle="modal-custom"></span></a>';
                    }
              

                    }
                },
               /*  { "mData": "lista", "aTargets":[3], "sortable":true }, */
                { "mData": "repeticion", "aTargets":[4], "sortable":true, "mRender": function(value, type, full){
							
						return 0 == value ? 'Siempre' : 'Cada ' + value + ' días';

					} 
				},
                { "mData": "impresiones", "aTargets":[5], "sortable":true },
                { "mData": "clicks", "aTargets":[6], "sortable":true },
