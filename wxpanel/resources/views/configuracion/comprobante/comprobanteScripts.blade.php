        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                ...
                { "mData": "clase", "aTargets":[1], "sortable":true },            
                { "mData": "letra", "aTargets":[2], "sortable":true },                  
                { "mData": "punto_venta", "aTargets":[3], "sClass": "center", "sortable":true },  
                { "mData": "descripcion", "aTargets":[4], "sortable":true },                            
                { "mData": "autoimpresion", "aTargets":[5], "sortable":true, "sClass": "center", "mRender": function(value, type, full){
						if (1 == value) {
							return 'Sí';
						} else {
							return 'No';
