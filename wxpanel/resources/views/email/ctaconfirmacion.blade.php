...
<!-- HEADER -->
<table class="head-wrap" background="{{asset('/')}}img/border.png" bgcolor="#000">
	<tr>
		<td></td>
		<td class="header container" >
				...
				<div class="content">
					<table>
						<tr>
							<td><img src="{{ \env('FE_URL').'img/logo.png'   }}" height="30" width="142" /></td>
...
<table class="body-wrap">
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF">
			<div class="content">
                <h2>Gracias {{ $nombre }} {{ $apellido }} por contactarse con Bymovi</h2>
                
                <h3>Nos comunicaremos con Ud. a la brevedad!</h3>
			</div><!-- /content -->									
		</td>
		<td></td>
	</tr>
