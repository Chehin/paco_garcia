			...
			<div id="template">
				<div id="template">
					<div id="template">
						...
						<p class="lead">Se ha solicitado la recuperación de contraseña en <b>{{ config('appCustom.clientName') }}</b>.</p>
						<p>Si fue usted el que ha pedido recuperar su contaseña, deberá ingresar al link que se muestra abajo. Si no fue usted, omita este mensaje.</p>
						<!-- Callout Panel -->
						<p class="callout">
							Click en este link: <a href="{{$link}}">&raquo; ¡Recuperar contraseña! &raquo;</a>
						</p><!-- /Callout Panel -->	
