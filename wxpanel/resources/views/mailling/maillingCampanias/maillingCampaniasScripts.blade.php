        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                ...
                { "mData": "fecha", "aTargets":[1], "sortable":true },
                { "mData": "fechaenvio", "aTargets":[2], "sortable":true },
                { "mData": "habilitado", "aTargets":[3], "sortable":false, "mRender": function(value, type, full){
