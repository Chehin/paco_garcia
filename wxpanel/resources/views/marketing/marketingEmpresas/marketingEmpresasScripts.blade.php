    ...
    $(document).ready(function() {
        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                { "mData": "razon_social", "aTargets":[0], "sortable":true },
                { "mData": "dominio", "aTargets":[1], "sortable":true },
                { "mData": "email", "aTargets":[2], "sortable":true },                
                { "mData": "direccion", "aTargets":[3], "sortable":true },
                { "mData": "telefono", "aTargets":[4], "sortable":true },
                { "mData": "pais", "aTargets":[5], "sortable":true },
                { "mData": "provincia", "aTargets":[6], "sortable":true },
                { "mData": "ciudad", "aTargets":[7], "sortable":true },
