        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                ...
                { "mData": "created_at", "aTargets":[1], "sortable":true, "mRender": function(value, type, full){
                        return moment(value, "YYYY-MM-DD").format("DD/MM/YYYY");
                    }
                },
                { "mData": null, "aTargets":[2], "sortable":false, "sClass": "center", "mRender": function(value, type, full){
				
                    return '('+ full.personasCnt +')&nbsp;' +
					'<a href="javascript:;" ><span data-href="'+ resourceReqOption3.edit.url(full.id) + '" data-toggle="modal-custom" style="font-size: 160%;" class="glyphicon glyphicon-th-list"></span></a>';

                }
                },
                { "mData": "autor", "aTargets":[3], "sortable":true },
