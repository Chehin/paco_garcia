    ...
    $(document).ready(function() {
        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                { "mData": "email", "aTargets":[0], "sortable":true },
                { "mData": "nombre", "aTargets":[1], "sortable":true },
                { "mData": "apellido", "aTargets":[2], "sortable":true },
                { "mData": "telefono", "aTargets":[3], "sortable":true },
                { "mData": "pais", "aTargets":[4], "sortable":true },
                { "mData": "provincia", "aTargets":[5], "sortable":true },
                { "mData": "ciudad", "aTargets":[6], "sortable":true },
