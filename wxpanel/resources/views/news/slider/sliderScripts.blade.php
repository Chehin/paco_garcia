<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
			...
			{ "mData": "orden", "aTargets":[1], "sortable":true },
			...
			//{ "mData": "posicion", "aTargets":[3], "sortable":true },
			{ "mData": null, "aTargets":[3], "sortable":false, "sClass": "center", "mRender": function(value, type, full){
				
				return '<a href="javascript:;" ><span data-href="'+ resourceReqOption2.edit.url(full.id) + '" data-toggle="modal-custom" style="font-size: 160%;" class="glyphicon glyphicon-th-list"></span></a>';
			...
			{ "mData": "", "aTargets":[4], "sortable":false, "mRender": function(value, type, full){
				...
				var checked = (1 == full.slider_texto) ? 'checked' : '';
				
				var slidertexto = '<div class="btn-group" style="margin-right:30px">'+
