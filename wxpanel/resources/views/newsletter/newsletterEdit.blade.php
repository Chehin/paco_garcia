    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h6 class="modal-title" id="myModalLabel">
                <i class="fa fa-picture-o fa-fw "></i> {{ ('edit' == $aViewData['mode']) ? 'Editar' : 'Agregar' }} {{$aViewData['resourceLabel']}}   
            </h6>
        </div>
<!-- NEW WIDGET START -->
                                                        ...
                                                        <div>
                                                                <section class="row">
                                                                        ...
                                                                        <label class="input col col-md-10 row">
                                                                            <input class="col col-md-12" type="text" name="email" required="" value="{{ ('edit' == $mode) ? $aItem['email'] : '' }}" />
                                                                        </label>
                                                                </section>
                                                        </div>
                                                <fieldset>
...
@include('newsletter.newsletterEditScripts')