...
<html lang="en-us">
	...
	<body>
		...
		<form action="{{ route('passwordForgot') }}" method="post" id="login-form" class="smart-form lockscreen animated flipInY client-form">
						...
						<section>
							...
							<label class="input"> 
								...
								<input type="text" name="email">
									<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Por favor ingrese su E-mail para recuperar su contraseña
								</b>
							</label>
						</section>
						<section>
