				...
				<div>
					...
					<div class="widget-body">
						...
						<div id="myTabContent3" class="tab-content padding-10">
							...
							<hr />
							<div class="row">
								<div class="col col-sm-12"><strong>Tipo de Envio:</strong> {{ isset($tipo_envio->nombre )?$tipo_envio->nombre:'No asignada'}}</div>
								<div class="col col-sm-6"><strong>Empresa:</strong> {{ isset($tipo_envio->empresa)?$tipo_envio->empresa:'' }}</div>
								<div class="col col-sm-6"><strong>Nro de Seguimiento:</strong> {{ $item->tracking_number }}</div>
							</div>
							@endif
