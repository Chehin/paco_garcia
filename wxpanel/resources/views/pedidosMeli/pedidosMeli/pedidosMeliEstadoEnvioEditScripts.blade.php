<script>
   ...
   $(function() {
        ...
        resourceReq.store.url = appCustom.{{$aViewData['resource']}}.estadoenvio.STORE.url;
        resourceReq.store.verb = appCustom.{{$aViewData['resource']}}.estadoenvio.STORE.verb;
       
        resourceReq.update.url = function(id){
            return appCustom.{{$aViewData['resource']}}.estadoenvio.UPDATE.url(id);
        };
        resourceReq.update.verb = appCustom.{{$aViewData['resource']}}.estadoenvio.UPDATE.verb;
        // end settings
