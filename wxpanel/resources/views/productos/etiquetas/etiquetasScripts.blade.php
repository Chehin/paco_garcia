    ...
    $(document).ready(function() {
        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
            ...
            "fnCreatedRow": function ( row, data, index ) {
                ...
                $(row).find('.onoffswitch[name=enable4] input', $('#' + resourceTableId)).on('change', onEnableAction4);
			},
            "aoColumnDefs": [
			{ "mData": "nombre", "aTargets":[0], "sortable":true },
			{ "mData": "menu", "aTargets":[1], "sortable":false, "mRender": function(value, type, full){ 
				var prefix = '1';
				var resourceTableId = prefix + '_' + resourceTableId;
				var checked = (1 == full.menu) ? 'checked' : '';
				
				var menuOption = '<div class="btn-group" style="margin-right:30px">'+
			...
			{ "mData": "menu", "aTargets":[2], "sortable":false, "mRender": function(value, type, full){ 
				var prefix = '2';
				var resourceTableId = prefix + '_' + resourceTableId;
				var checked = (1 == full.slider) ? 'checked' : '';
        ...
        var onEnableAction4 = function(e) {
            var id = $(e.target).val();
            var enable = ($(this).prop('checked')) ? 1:0;
