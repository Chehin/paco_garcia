...
$(document).ready(function() {
        ...
        resourceReq.index.url = appCustom.{{$aViewData['resource']}}.productosRelatedColor.INDEX.url;
        resourceReq.index.verb = appCustom.{{$aViewData['resource']}}.productosRelatedColor.INDEX.verb;
        
        resourceReq.store.url = appCustom.{{$aViewData['resource']}}.productosRelatedColor.STORE.url;
        resourceReq.store.verb = appCustom.{{$aViewData['resource']}}.productosRelatedColor.STORE.verb;
        
        resourceReq.edit.url = function(id){
            return appCustom.{{$aViewData['resource']}}.productosRelatedColor.EDIT.url(id);
        };
        resourceReq.edit.verb = appCustom.{{$aViewData['resource']}}.productosRelatedColor.EDIT.verb;
        
        resourceReq.update.url = function(id){
            return appCustom.{{$aViewData['resource']}}.productosRelatedColor.UPDATE.url(id)
        };
        resourceReq.update.verb = appCustom.{{$aViewData['resource']}}.productosRelatedColor.UPDATE.verb;
        
        resourceReq.delete.url = function(id){
            return appCustom.{{$aViewData['resource']}}.productosRelatedColor.DELETE.url(id);
        };
        resourceReq.delete.verb = appCustom.{{$aViewData['resource']}}.productosRelatedColor.DELETE.verb;
        // end settings
        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
           ...
           "oTableTools" : {
            ...
            "aoColumnDefs": [
                ...
                { "mData": "rubro", "aTargets":[3], "sortable":true },
