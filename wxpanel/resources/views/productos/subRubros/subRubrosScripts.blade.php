           ...
           "oTableTools" : {
            ...
            "initComplete": function ()
            {
				...
				var $select = '{{ Form::select(
					'rubros', 
					$aViewData['aCustomViewData']['aRubros'],
					null,
					['style' => 'width:128px;']
					) 
				}}';
                $('.filtro-mas').append($select);
				$('select[name=rubros]').prepend('<option selected value="">Rubros</option>');
				$('.filtro-mas select[name=rubros]').on('change', onChangeFiltroMas);
            ...
            "aoColumnDefs": [
                ...
                { "mData": "rubro", "aTargets":[2], "sortable":true },
                { "mData": "menu", "aTargets":[3], "sortable":false, "mRender": function(value, type, full){ 
                    var prefix = '1';
