                        ...
                        <!--        <p>
                                ...
                                {{ Form::open(array('id' => $aViewData['resource'] . 'Form', 'name' => $aViewData['resource'] . 'Form')) }}
                                        ...
                                        <div class="tab-pane fade active in" id="l1">
                                                ...
                                                <fieldset>
                                                        <div>
                                                                <input class="col col-md-12" type="hidden" name="id_seccion" value="3" />
                                                                <section class="row">
                                                                        <label class="col col-md-2">Código *:</label>
                                                                ...
                                                                <section class="row">
                                                                        <label class="col col-md-2">Dirección *:</label>
                                                                        <label class="input col col-md-10 row">
                                                                            <input class="col col-md-12" type="text" name="sumario" required="" value="{{ ('edit' == $mode) ? $aItem['sumario'] : '' }}" />
                                                                        </label>
                                                                </section>
                                                                <section class="row">
                                                                        <label class="col col-md-2">Ciudad *:</label>
                                                                        <label class="input col col-md-10 row">
                                                                            <input class="col col-md-12" type="text" name="ciudad" required="" value="{{ ('edit' == $mode) ? $aItem['ciudad'] : '' }}" />
                                                                        </label>
                                                                </section>
                                                                <section class="row">
                                                                        <label class="col col-md-2">Email:</label>
                                                                        <label class="input col col-md-10 row">
                                                                            <input class="col col-md-12" type="email" name="email" value="{{ ('edit' == $mode) ? $aItem['email'] : '' }}" />
                                                                        </label>
                                                                </section>
                                                                <section class="row">
...
@include('sucursales.sucursalesEditScripts')