...
$aPremissionsAssigned = ($item->permissions ) ?  $item->permissions : [];
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h6 class="modal-title" id="myModalLabel">
				<i class="fa fa-lock fa-fw "></i> {{ ('edit' == $aViewData['mode']) ? 'Editar ' . $aViewData['resourceLabel'] : 'Agregar ' . $aViewData['resourceLabel'] }}   
			</h6>
        </div>
<!-- NEW WIDGET START -->
        ...
        <div class="jarviswidget well" id="wid-id-4" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                ...
                <div>
					...
					<li class="pull-right active">
						<a href="#l2" data-toggle="tab">Permisos del Perfil: <b>"{{ $item->name }}"</b></a>
					</li>
                                </ul>
																					...
																					<label class="checkbox-inline">
																						...
																						@foreach($aMod['aPermissions'] as $pKey => $aPermission)
																							<label class="checkbox-inline">
																								...
																								<span> {{ App\Http\Controllers\User\PermissionUtilController::permissionLabel($pKey) }}</span>
																							</label>
																						@endforeach
...
<script>
    ...
    $(function(){
		...
		resourceReq.update.url = function(id){
            return appCustom.permission.UPDATE.url(id);
        };
        resourceReq.update.verb = appCustom.permission.UPDATE.verb;
		//end config
