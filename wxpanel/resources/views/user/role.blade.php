...
<div class="row">
    ...
    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-4 text-right">
            ...
            <button id="resourceAdd" data-href="" class="btn btn-sm btn-success" data-toggle="modal-custom" data-remote="true"> <i class="fa fa-plus"></i> Agregar
			</button>
			@endif
    </div>
</div>
...
@section('custom_css_container')
@stop

@section('custom_scripts_container')
	@include('user.roleScripts')
@stop
